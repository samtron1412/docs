...
- `git apply --stat xdg-utils-v1.1.1.patch`: Show diffstat instead of applying the patch
- `git apply --check xdg-utils-v1.1.1.patch`: Check if the patch is applicable toe the current working tree and/or the index and detects errors.
